      ...
      <section className="bg-[#1B2B4B] px-4 pb-20 pt-40 text-white sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl text-center">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-lg leading-8 text-white/70">
            Learn practical guidance for navigating retirement with clarity,
            purpose, structure, and confidence.
          </p>
        </div>
      </section>
      ...
      <section className="bg-white px-4 py-16 text-center sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <p className="mx-auto mt-4 max-w-2xl leading-8 text-[#1B2B4B]/65">
            Start with the retirement readiness assessment to better understand
            your personal transition profile.
          </p>

          <Button
            asChild
            className="mt-8 cursor-pointer rounded-full bg-[#C9A84C] px-8 py-6 text-base font-semibold text-[#1B2B4B] hover:bg-[#D6B45A]"
          >
