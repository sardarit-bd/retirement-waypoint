              ...
              {navLinks.map(({ name, href }) =>
                isComingSoonRoute(href) ? (
                  <button
                    ...
                    className={`cursor-pointer rounded-full px-4 py-2 text-sm font-medium transition-all duration-300 lg:text-base ${navTextClass}`}
                  >
                    {name}
                  </button>
                ) : (
