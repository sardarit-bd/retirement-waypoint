    ...
    >
      ...
      <form onSubmit={handleSubmit} className="mt-6 space-y-4">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
          type="submit"
          className="w-full rounded-2xl bg-gradient-to-r from-indigo-600 to-purple-600 py-3.5 text-sm font-semibold text-white shadow-lg shadow-indigo-600/20"
        >
          Sign In
        </motion.button>
      </form>
      ...
      <div className="mt-6">
        ...
        <motion.button
          whileHover={{ scale: 1.02 }}
          whileTap={{ scale: 0.98 }}
          className="mt-4 flex w-full items-center justify-center gap-3 rounded-2xl border border-slate-700/60 bg-slate-800/60 py-3.5 text-sm font-medium text-slate-200 transition-colors hover:bg-slate-700/60"
        >
