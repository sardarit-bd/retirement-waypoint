    ...
    return (
      <div className="mx-auto max-w-4xl p-3 sm:p-4 md:p-6">
        <div className={`${cardClass} flex flex-col items-center justify-center p-12 text-center`}>
          ...
          <Button
            className="mt-4 rounded-full bg-[#C9A84C] font-semibold text-[#1B2B4B] hover:bg-[#D6B45A]"
            onClick={() => router.back()}
          >
            Go Back
          </Button>
    ...
    >
      ...
      <div className="flex flex-wrap items-center gap-3">
        <Button
          ...
          className="h-9 rounded-full border border-[#1B2B4B]/10 px-3 text-[#1B2B4B] hover:bg-[#F8F5EF]"
        >
      ...
      <Card className={cardClass}>
        ...
        <CardContent>
          <div className="flex flex-wrap gap-2">
            ...
            <Button
              asChild
              className="ml-auto rounded-full bg-[#C9A84C] font-semibold text-[#1B2B4B] hover:bg-[#D6B45A]"
            >
